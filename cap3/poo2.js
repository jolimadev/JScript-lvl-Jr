class Celular {
	...
	mobileInfo(){
		...
		`;
	}//este es el metodo anterior del problema a, pero con las nuevas características
}


class CelularAltaGama extends Celular { //el extends permite la herencia
...
} //ESTE ES UN METODO QUE RETORNA LA INFO DEL NUEVO CELU ALTA GAMA
